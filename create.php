...
<div class="card shadow-sm"> <!-- Added card wrapper -->
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-4"> <!-- Better header -->
            <h2>Create Post</h2>
        ...
        <form method="post">
            <div class="mb-3">
                ...
                <div class="form-text">Make it catchy and descriptive</div> <!-- Help text -->
            </div>
            <div class="mb-3">
                <label class="form-label">Content</label>
                <textarea name="content" class="form-control" rows="8" placeholder="Write your post content here..." required></textarea>
                <div class="form-text">Markdown is supported</div> <!-- Help text -->
            </div>
            <div class="d-flex justify-content-end gap-2"> <!-- Better button alignment -->
